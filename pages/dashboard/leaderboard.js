        ...
        <div className="tab-pane fade show active" id="tab-2" role="tabpanel" aria-labelledby="pills-tab-2">
            ...
            <div className="pt-5">
              <div className="d-flex member-cards pt-md-0 pt-4 mt-5">
                <div className="member-card mc-2nd">
                  <img src="/dashboard-assets/img/crown-silver.svg" alt="Crown" className="crown-img" />
                  <span className="mc-standing">
                    <img src="/dashboard-assets/img/second.svg" alt="Crown" height="35" className="place-badge" />
                  </span>
                  <div className="position-static">
                    <a href="javascript:void(0)" onClick={() => { openModal('user') }}>
                      <img src="https://ui-avatars.com/api/?name=gilmilli7&color=7F9CF5&background=EBF4FF" className="mc-img cursor-pointer" />
                    </a>
                  </div>
                  ...
                  <div className="mc-prize f-12p fw-bold">
                    <span className="mcp-text">
                      <svg width="15" className="me-1" height="17" viewBox="0 0 15 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0.374853 3.90369C0.151497 3.98703 -0.00185204 4.19372 -0.00185204 4.43374V5.58053C-0.00185204 9.66429 2.09837 13.4547 5.56206 15.6182L6.84219 16.415C7.02555 16.5283 7.25557 16.5283 7.43559 16.415L8.71572 15.6182C12.1861 13.4547 14.293 9.66429 14.293 5.58053V4.43374C14.293 4.19372 14.1396 3.98703 13.9163 3.90369C12.3494 3.31696 11.106 2.37353 10.3992 0.840035C10.3059 0.636681 10.1092 0.5 9.88584 0.5H4.3986C4.17525 0.5 3.97856 0.636681 3.88522 0.840035C3.18515 2.37686 1.94168 3.31696 0.374853 3.90369Z" fill="#E1E1E1" fill-opacity="0.2"></path>
                ...
                <div className="member-card mc-1st">
                  <img src="/dashboard-assets/img/crown-1st.svg" alt="Crown" className="crown-img" />
                  <span className="mc-standing">
                    <img src="/dashboard-assets/img/first.svg" alt="Crown" height="48" className="place-badge" />
                  </span>
                  <div className="position-static">
                    <a href="javascript:void(0)" onClick={() => { openModal('user') }}>
                      <img src="https://dolares.app/assets/img/crown.png" alt="Crown" className="mc-crown" />
                      <img src="https://dolares.app/public/storage/users/uaWtToDVg1VtplAmk48vfXJQyEkuyRybyfInRnT5EGN8uEakgO.jpg" className="mc-img cursor-pointer" />
                    </a>
                  </div>
                  <p className="fw-medium mb-2 pb-1 mc-name f-20p mt-4 cursor-pointer" onClick={() => { openModal('user') }}>
                    moramondolina
                  ...
                  <div className="mc-prize f-12p fw-bold">
                    <span className="mcp-text">
                      <svg width="15" className="me-1" height="17" viewBox="0 0 15 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0.374853 3.90369C0.151497 3.98703 -0.00185204 4.19372 -0.00185204 4.43374V5.58053C-0.00185204 9.66429 2.09837 13.4547 5.56206 15.6182L6.84219 16.415C7.02555 16.5283 7.25557 16.5283 7.43559 16.415L8.71572 15.6182C12.1861 13.4547 14.293 9.66429 14.293 5.58053V4.43374C14.293 4.19372 14.1396 3.98703 13.9163 3.90369C12.3494 3.31696 11.106 2.37353 10.3992 0.840035C10.3059 0.636681 10.1092 0.5 9.88584 0.5H4.3986C4.17525 0.5 3.97856 0.636681 3.88522 0.840035C3.18515 2.37686 1.94168 3.31696 0.374853 3.90369Z" fill="#EF7C16" fill-opacity="0.2"></path>
                        <path d="M5.74297 5.25V4.21H7.82297V11.5H6.67297V5.25H5.74297Z" fill="#EF7C16"></path>
                      </svg>
                      Prize
                    </span>
                    <img src="https://dolares.app/assets/img/coin (1).png" height="10" alt="coin" className="mcp-img" />
                ...
                <div className="member-card mc-3rd">
                  <img src="/dashboard-assets/img/crown-silver.svg" alt="Crown" className="crown-img" />
                  <span className="mc-standing">
                    <img src="/dashboard-assets/img/third.svg" alt="Crown" height="35" className="place-badge" />
                  </span>
                  <div className="position-static">
                    <a href="javascript:void(0)" onClick={() => { openModal('user') }}>
                      <img src="https://dolares.app/public/storage/users/XawBCIAkdVOfFxC8KexwuTx8rNWLCpzfFCMlQS4kMUIaDLVWph.jpg" className="mc-img cursor-pointer" />
                    </a>
                  </div>
                  <p className="fw-medium mb-2 pb-1 mc-name f-20p mt-4 cursor-pointer" onClick={() => { openModal('user') }}>
                    Jeremy
                  ...
                  <div className="mc-prize f-12p fw-bold">
                    <span className="mcp-text">
                      <svg width="15" className="me-1" height="17" viewBox="0 0 15 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0.374853 3.90369C0.151497 3.98703 -0.00185204 4.19372 -0.00185204 4.43374V5.58053C-0.00185204 9.66429 2.09837 13.4547 5.56206 15.6182L6.84219 16.415C7.02555 16.5283 7.25557 16.5283 7.43559 16.415L8.71572 15.6182C12.1861 13.4547 14.293 9.66429 14.293 5.58053V4.43374C14.293 4.19372 14.1396 3.98703 13.9163 3.90369C12.3494 3.31696 11.106 2.37353 10.3992 0.840035C10.3059 0.636681 10.1092 0.5 9.88584 0.5H4.3986C4.17525 0.5 3.97856 0.636681 3.88522 0.840035C3.18515 2.37686 1.94168 3.31696 0.374853 3.90369Z" fill="#403E51"></path>
                        <path d="M4.87297 6.01C4.91297 5.39 5.14964 4.90667 5.58297 4.56C6.02297 4.21333 6.58297 4.04 7.26297 4.04C7.72964 4.04 8.13297 4.12333 8.47297 4.29C8.81297 4.45667 9.06964 4.68333 9.24297 4.97C9.4163 5.25667 9.50297 5.58 9.50297 5.94C9.50297 6.35333 9.39297 6.70667 9.17297 7C8.95297 7.29333 8.68964 7.49 8.38297 7.59V7.63C8.7763 7.75 9.08297 7.97 9.30297 8.29C9.52297 8.60333 9.63297 9.00667 9.63297 9.5C9.63297 9.89333 9.54297 10.2433 9.36297 10.55C9.18297 10.8567 8.9163 11.1 8.56297 11.28C8.20964 11.4533 7.7863 11.54 7.29297 11.54C6.57297 11.54 5.97964 11.3567 5.51297 10.99C5.05297 10.6167 4.8063 10.0833 4.77297 9.39H5.87297C5.89964 9.74333 6.0363 10.0333 6.28297 10.26C6.52964 10.48 6.86297 10.59 7.28297 10.59C7.68964 10.59 8.00297 10.48 8.22297 10.26C8.44297 10.0333 8.55297 9.74333 8.55297 9.39C8.55297 8.92333 8.40297 8.59333 8.10297 8.4C7.80964 8.2 7.3563 8.1 6.74297 8.1H6.48297V7.16H6.75297C7.29297 7.15333 7.70297 7.06333 7.98297 6.89C8.26964 6.71667 8.41297 6.44333 8.41297 6.07C8.41297 5.75 8.30964 5.49667 8.10297 5.31C7.8963 5.11667 7.60297 5.02 7.22297 5.02C6.84964 5.02 6.55964 5.11667 6.35297 5.31C6.1463 5.49667 6.02297 5.73 5.98297 6.01H4.87297Z" fill="white"></path>
                      </svg>
                      Prize
                    </span>
                    <img src="https://dolares.app/assets/img/coin (1).png" height="10" alt="coin" className="mcp-img" />
          ...
          <div className="py-5 d-flex justify-content-center gap-3 flex-wrap">
            <div className="d-flex lb-pill py-3 px-5 rounded-pill gap-1 align-items-center f-16p fw-medium">
              ...
              <span className="fw-semibold f-16p text-white">
                7.500
              </span>
              <span className="text-white">
                Today
            ...
            <div className="d-flex lb-pill py-3 px-5 rounded-pill gap-1 align-items-center f-16p fw-medium">
              ...
              <span className="d-flex align-items-center gap-1">
                <span className="timer-day text-white">
                  28d
                </span>
                <span className="timer-day text-white">
                  :
                  ...
                  <table className="table table-separated table-borderless table-referrals">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <div className="fw-semibold text-white f-16p ps-lg-5 d-flex align-items-center justify-content-center badge-position">
                            <img src="/dashboard-assets/img/first.svg" alt="Place" height="48" className="standing-icon" />
                          </div>
                        </td>
                        <td>
                        ...
                        <td>
                          <div className="text-white fw-semibold f-16p">
                            <span>
                              2343
                            </span>
                          </div>
                      ...
                      <tr>
                        <td>
                          <div className="fw-semibold text-white f-16p ps-lg-5 d-flex align-items-center justify-content-center badge-position">
                            <img src="/dashboard-assets/img/second.svg" alt="Place" height="48" className="standing-icon" />
                          </div>
                        </td>
                        <td>
                          <a href="#" onClick={() => { openModal('user') }} className="tar-user d-flex align-items-center gap-2 fw-semibold f-16p">
                      ...
                      <tr>
                        <td>
                          <div className="fw-semibold text-white f-16p ps-lg-5 d-flex align-items-center justify-content-center badge-position">
                            <img src="/dashboard-assets/img/third.svg" alt="Place" height="48" className="standing-icon" />
                          </div>
                        </td>
                        <td>
                          <a href="#" onClick={() => { openModal('user') }} className="tar-user d-flex align-items-center gap-2 fw-semibold f-16p">
                      ...
                      <tr>
                        <td>
                          <div className="fw-semibold text-white f-16p ps-lg-5 d-flex align-items-center justify-content-center badge-position">
                            <span className="simple-position">
                              <span>
                                4
                              </span>
                            </span>
