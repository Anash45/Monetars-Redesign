...
const TIERS = [
  ...
  { tier: "Tire 2", earning: "$50 Affilliate earning", commission: "5% Commission", done: true },
  { tier: "Tire 3", earning: "$150 Affilliate earning", commission: "10% Commission" },
  { tier: "Tire 4", earning: "$300 Affilliate earning", commission: "12% Commission" },
  { tier: "Tire 5", earning: "$500 Affilliate earning", commission: "15% Commission" },
  { tier: "Tire 6", earning: "$1000 Affilliate earning", commission: "18% Commission" },
  { tier: "Tire 7", earning: "$2500 Affilliate earning", commission: "20% Commission" },
  { tier: "Tire 8", earning: "$5000 Affilliate earning", commission: "25% Commission" },
];

const REFERRALS = [
  { name: "Adeel Raza", date: "24 September 2024", earning: 1500 },
  { name: "Mia Chen", date: "18 September 2024", earning: 900 },
  { name: "Ryan Okafor", date: "12 September 2024", earning: 640 },
  { name: "Jasmine Lowe", date: "5 September 2024", earning: 320 },
  { name: "Devon Parker", date: "28 August 2024", earning: 1150 },
];

const PROMO_CARDS = [
  { className: "pc-1", img: "/dashboard-assets/img/promo1.png" },
  { className: "pc-2", img: "/dashboard-assets/img/promo2.png" },
  { className: "pc-3", img: "/dashboard-assets/img/promo3.png" },
];

function SocialIcons({ color = "#7C77B4" }) {
  return (
    ...
    <div className="site-card">
      <div className="bg-transparent pt-4 px-md-5 px-4">
        <div className="d-flex justify-content-between gap-3 flex-lg-nowrap flex-wrap w-100">
          <div className={`d-flex flex-column gap-0 align-items-${withSocials ? "lg-start align-items-center text-lg-start" : "xxl-start align-items-center text-xxl-start"} text-center w-100`}>
            <h3 className={`f-28p fw-semibold d-flex align-items-center mb-0 gap-lg-3 gap-2 flex-wrap text-white ${withSocials ? "justify-content-between w-100 flex-lg-row flex-column" : "align-items-bottom gap-0"}`}>
              <span>{withSocials ? "Refer & Earn" : "Affiliate Program"}</span>
              {withSocials && <SocialIcons />}
            </h3>
      ...
      <section className="affiliate-sec py-5">
        <div className="container pe-xxl-5">
          <div className="nav-tabs-cont px-md-4 px-0 mb-md-4 mb-2">
            <h3 className="mb-0 f-26p fw-semibold poppins text-white">Affiliate</h3>
            <ul className="nav nav-pills mb-0" id="pills-tab" role="tablist">
              <li className="nav-item" role="presentation">
                <a className="nav-link active" id="pills-tab-2" data-bs-toggle="pill" href="#tab-2" role="tab" aria-controls="tab-2" aria-selected="true">General</a>
              </li>
              <li className="nav-item" role="presentation">
                <a className="nav-link" id="pills-tab-1" data-bs-toggle="pill" href="#tab-1" role="tab" aria-controls="tab-1" aria-selected="false">Referrals</a>
              </li>
              <li className="nav-item" role="presentation">
                <a className="nav-link" id="pills-tab-3" data-bs-toggle="pill" href="#tab-3" role="tab" aria-controls="tab-3" aria-selected="false">Promo</a>
              </li>
            </ul>
          </div>
                ...
                <div className="aff-stats-box px-4 py-4">
                  <div className="d-flex asb-flex px-lg-3 py-2 flex-wrap">
                    <div className="af-stat">
                      <span className="af-text">Total Referrals</span>
                      <span className="d-flex flex-column align-items-center justify-content-center af-circle"><span>0</span></span>
                    </div>
                    <div className="af-stat">
                      <span className="af-text">Total Claimed</span>
                      <span className="d-flex flex-column align-items-center justify-content-center af-circle"><span>0</span></span>
                    </div>
                    <div className="af-stat">
                      <span className="af-text">Total Earnt</span>
                      <span className="d-flex flex-column align-items-center justify-content-center af-circle"><span>0</span></span>
                    </div>
                  </div>
                </div>
                <ReferralLinkCard withSocials={false} />
                  ...
                  <div className="pe-lg-3">
                    <div className="table-responsive">
                      <table className="table table-separated table-borderless table-aff-general ps-5">
                        <tbody>
                          {TIERS.map((row, i) => (
                            <tr className={`tag-row ${row.done ? "tag-done" : ""}`} key={i}>
                              <td><div className="ps-lg-5 tag-tier fw-semibold f-20p">{row.tier}</div></td>
                              <td><div className="tag-earning fw-semibold f-16p">{row.earning}</div></td>
                              <td><div className="tag-comission fw-semibold f-16p text-center">{row.commission}</div></td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
              ...
              <div className="d-flex flex-column gap-4">
                <div className="aff-stats-box px-4 py-4">
                  <div className="d-flex asb-flex px-lg-3 py-2 flex-wrap">
                    ...
                    <div className="af-stat">
                      <span className="af-text">Referral Earnings</span>
                      <span className="d-flex flex-column align-items-center justify-content-center af-circle"><span>0</span></span>
                    </div>
                  </div>
                </div>
                <ReferralLinkCard withSocials />
                  ...
                  <div className="pe-lg-3">
                    <div className="table-responsive">
                      <table className="table table-separated table-borderless table-referrals ps-lg-5">
                        <thead>
                          <tr>
                            <th><span className="ps-lg-5">Username</span></th>
                            <th>Registered</th>
                            <th>Earnings</th>
                          </tr>
                        </thead>
                        <tbody>
                          {REFERRALS.map((row, i) => (
                            <tr key={i}>
                              ...
                              <td><div className="tar-date fw-semibold f-16p"><span>{row.date}</span></div></td>
                              <td>
                                <div className="tar-earning d-flex align-items-center gap-1 fw-semibold f-16p text-center">
                                  ...
                                  <span className="text-white">{row.earning}</span>
                                </div>
                              </td>
                            </tr>
                          ))}
              ...
              <div className="d-flex flex-column gap-4">
                ...
                <div className="promo-flex-1 d-flex gap-4 flex-wrap">
                  {PROMO_CARDS.map((card, i) => (
                    <div className={`promo-card ${card.className}`} key={i}>
                      <img src={card.img} alt="Promo" className="promo-img img-fluid" />
