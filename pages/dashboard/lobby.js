...
const LOBBY_CARDS = [
  { className: "lc-orange", title: "EARN BATTLE", text: "Lorem ipsum dolor sit amet, Lorem ipsum dolor sit amet, Lorem ipsum" },
  { className: "lc-purple", title: "INVITE BATTLE", text: "Lorem ipsum dolor sit amet, Lorem ipsum dolor sit amet, Lorem ipsum" },
];

const RECENT_OFFERS = [
  { img: "/dashboard-assets/img/offers-cards/rc-1.png", amount: "$229", provider: "Adgate Media" },
  { img: "/dashboard-assets/img/offers-cards/rc-2.png", amount: "$85", provider: "Lootably" },
  { img: "/dashboard-assets/img/offers-cards/rc-3.png", amount: "$412", provider: "TimeWall" },
  { img: "/dashboard-assets/img/offers-cards/rc-4.png", amount: "$156", provider: "Notik" },
];
...
const ACTIVITY_ROWS = {
  All: [
    ...
    { name: "Survey Completed", user: "Ryan Okafor", provider: "TheoremReach", time: "12m ago", prize: 320 },
  ],
  Offers: [
    { name: "Offer Completed", user: "Adeel Raza", provider: "AdGateMedia", time: "Now", prize: 1500 },
    { name: "Offer Completed", user: "Jasmine Lowe", provider: "Lootably", time: "8m ago", prize: 640 },
    { name: "Offer Completed", user: "Devon Parker", provider: "Monlix", time: "20m ago", prize: 275 },
  ],
  Withdrawls: [
    { name: "Cashout Requested", user: "Keisha Nolan", provider: "Amazon", time: "2m ago", prize: 2000 },
    { name: "Cashout Requested", user: "Mia Chen", provider: "PayPal", time: "15m ago", prize: 900 },
    { name: "Cashout Requested", user: "Wayne Gordon", provider: "Spotify", time: "1h ago", prize: 500 },
  ],
};
        ...
        <div className="pe-lg-3">
          <div className="table-responsive">
            <table className="table table-separated table-borderless table-referrals table-activity ps-lg-3">
              <thead>
                <tr>
                  <th><span className="ps-lg-5">Name</span></th>
              ...
              <tbody>
                {rows.map((row, i) => (
                  <tr key={i}>
                    <td>
                      <div className="fw-medium f-16p ps-lg-5">{row.name}</div>
                    </td>
                    <td>
                    ...
                    <td>
                      <div className="fw-medium f-16p"><span>{row.provider}</span></div>
                    </td>
                    <td>
                      <div className="fw-medium f-16p"><span>{row.time}</span></div>
                    </td>
                    <td>
      ...
      <section className="affiliate-sec py-5">
        <div className="container pe-xxl-5">
          <div className="home-offer" id="home-offers">
            <div className="mb-5 lobby-cards d-lg-flex d-none gap-3">
              {LOBBY_CARDS.map((card, i) => (
                <div className={`lobby-card ${card.className}`} key={i}>
                  <div className="lc-content">
                    <h2 className="lc-title text-white mb-2">{card.title}</h2>
                    <p className="text-white mb-0 lato f-18p">{card.text}</p>
                  </div>
                </div>
              ))}
            </div>
            <div className="offers-container oc-recently mt-0 mb-5">
              <div className="mb-0 py-2 d-flex align-items-center of-title justify-content-between">
                <h2 className="page-title mb-0 fw-semibold f-28p ms-2 text-white">Recently Completed</h2>
                <div className="pe-md-5 me-md-5">
                  <a href="#" className="view-link f-16p fw-semibold me-md-3">View All</a>
                </div>
              </div>
              <div className="py-2">
                  ...
                  {RECENT_OFFERS.map((offer, i) => (
                    <div className="mx-2" key={i}>
                      <div onClick={() => { openModal('offer') }} className="offer-box ob-first ob-recent position-relative">
                        <img src={offer.img} alt="Offer" className="rc-img" />
                        <div className="d-flex flex-column gap-2 rc-content">
                          <span className="rc-pill"><span>{offer.amount}</span></span>
                          <span className="rc-title"><span>{offer.provider}</span></span>
                        </div>
                      </div>
                    </div>
                  ))}
            ...
            <div className="offers-container oc-offer-walls mt-0 mb-5">
              <div className="mb-0 py-2 d-flex align-items-center of-title justify-content-between">
                <h2 className="page-title mb-0 fw-semibold f-28p ms-2 text-white">Offer Walls</h2>
              </div>
              <div className="py-2">
                <div className="d-flex offers mt-2">
                  {OFFER_WALLS.map((wall, i) => (
                    <div className="mx-2" key={i}>
                      <div onClick={() => { openModal('signin') }} className="offer-box ob-first ob-simple" style={{ backgroundColor: `${wall.bg} !important` }}>
                        {wall.percent && (
                        ...
                        <img src={wall.img} alt={wall.name} className="ob-main-img" />
                        <span className="ob-name text-white">{wall.name}</span>
          ...
          <div className="nav-tabs-cont px-md-4 px-0 mb-md-4 mb-2">
            <h3 className="mb-0 f-26p fw-semibold poppins text-white">Activity</h3>
            <ul className="nav nav-pills mb-0" id="pills-tab" role="tablist">
              <li className="nav-item" role="presentation">
                <a className="nav-link active" id="pills-tab-2" data-bs-toggle="pill" href="#tab-2" role="tab" aria-controls="tab-2" aria-selected="true">All</a>
              </li>
              <li className="nav-item" role="presentation">
                <a className="nav-link" id="pills-tab-1" data-bs-toggle="pill" href="#tab-1" role="tab" aria-controls="tab-1" aria-selected="false">Offers</a>
              </li>
              <li className="nav-item" role="presentation">
                <a className="nav-link" id="pills-tab-3" data-bs-toggle="pill" href="#tab-3" role="tab" aria-controls="tab-3" aria-selected="false">Withdrawls</a>
              </li>
            </ul>
